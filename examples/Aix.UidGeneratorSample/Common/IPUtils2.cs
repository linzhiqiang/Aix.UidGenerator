...
namespace Aix.UidGeneratorSample.Common
{
    public class IPUtils2
    {
       ...
       .FirstOrDefault()?.Address.ToString();
        ...
        //public static long IPLast2ToInt()
        //{
        //    return IPLast2ToInt(GetLocalIP());
        //}
        //public static long IPLast2ToInt(String ipAddress)
        //{
        //    //将目标IP地址字符串strIPAddress转换为数字
        //    string[] arrayIP = ipAddress.Split('.');
        //    long sip1 = long.Parse(arrayIP[0]);
